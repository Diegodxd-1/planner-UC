...
| Technical Debt | `178 min` | Se reduce desde `434 min` |
...
| Code Smells | `110` | `26` | Reduccion de `84` hallazgos |
| Issues abiertos | `111` | `26` | Reduccion de `85` issues |
| Severidad critica | `5` | `0` | Sin issues criticos abiertos |
| Security Rating | `C` | `A` | Seguridad normalizada |
| Technical Debt | `434 min` | `178 min` | Reduccion de `256 min` |
