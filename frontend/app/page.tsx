...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(14,165,233,0.18),_transparent_28%),linear-gradient(180deg,#f7fbff_0%,#eef6ff_46%,#f8fafc_100%)] text-slate-900">
